...
var AccountCloudplayerModel = /** @class */ (function (_super) {
  __extends(AccountCloudplayerModel, _super);

  function AccountCloudplayerModel() {
    var _this = _super !== null && _super.apply(this, arguments) || this;
    _this.endpoint = '/account';
    return _this;
  }

  AccountCloudplayerModel.prototype.getFullName = function () {
    return this.title;
  };
  __decorate([
    attributes_key_decorator_1.attributesKey('provider_id'),
    default_value_decorator_1.defaultValue('cloudplayer')
  ], AccountCloudplayerModel.prototype, "provider", void 0);
  __decorate([
    attributes_key_decorator_1.attributesKey('image'),
    nested_decorator_1.nested()
  ], AccountCloudplayerModel.prototype, "image", void 0);
  __decorate([
    attributes_key_decorator_1.attributesKey('title'),
    default_value_decorator_1.defaultValue('')
  ], AccountCloudplayerModel.prototype, "title", void 0);
  __decorate([
    attributes_key_decorator_1.attributesKey('playlists'),
    nested_decorator_1.nested()
  ], AccountCloudplayerModel.prototype, "playlists", void 0);
  __decorate([
    attributes_key_decorator_1.attributesKey('tracks'),
    nested_decorator_1.nested()
  ], AccountCloudplayerModel.prototype, "tracks", void 0);
  return AccountCloudplayerModel;
}(cloud_player_model_1.CloudplayerModel));
exports.AccountCloudplayerModel = AccountCloudplayerModel;
