...
/***/ function(module, exports, __webpack_require__) {
	...
	const dashboard_module_1 = __webpack_require__(172);
	const main_component_1 = __webpack_require__(211);
	const main_routes_1 = __webpack_require__(214);
	const audio_player_module_1 = __webpack_require__(215);
	const session_module_1 = __webpack_require__(178);
	const users_module_1 = __webpack_require__(226);
	const common_1 = __webpack_require__(22);
	const nav_component_1 = __webpack_require__(228);
	const playlist_module_1 = __webpack_require__(200);
	const auth_service_1 = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const toggle_liked_track_component_1 = __webpack_require__(116);
	const play_button_component_1 = __webpack_require__(129);
	const platform_browser_1 = __webpack_require__(21);
	const queue_button_component_1 = __webpack_require__(134);
	const sort_tracks_component_1 = __webpack_require__(137);
	const backbone_module_1 = __webpack_require__(64);
	const range_slider_component_1 = __webpack_require__(140);
	const forms_1 = __webpack_require__(60);
	const draggable_directive_1 = __webpack_require__(143);
	const dropzone_directive_1 = __webpack_require__(144);
	const two_range_slider_component_1 = __webpack_require__(145);
	const view_header_component_1 = __webpack_require__(148);
	const scroll_view_component_1 = __webpack_require__(151);
	const cloud_player_logo_service_1 = __webpack_require__(154);
	const cloud_player_logo_component_1 = __webpack_require__(155);
	const toggle_switch_component_1 = __webpack_require__(159);
	const loading_spinner_component_1 = __webpack_require__(162);
	const collection_text_input_search_component_1 = __webpack_require__(165);
	const focus_input_directive_1 = __webpack_require__(168);
	const view_change_loader_component_1 = __webpack_require__(169);
...
/***/ function(module, exports) {
	...
	module.exports = "@import url(\"https://fonts.googleapis.com/css?family=Raleway:300,400,500,600\");\n.tracks-list {\n  background: #fcfcfc;\n  padding: 10px 15px;\n  border-radius: 4px;\n  box-shadow: 0 0 8px 0 #c8c8c8; }\n  .tracks-list div.track {\n    display: flex;\n    margin: 15px auto; }\n    .tracks-list div.track div.cover {\n      order: 1;\n      flex: auto 0 0;\n      max-width: 150px; }\n      .tracks-list div.track div.cover img {\n        width: 150px;\n        height: 150px; }\n    .tracks-list div.track div.details {\n      order: 2;\n      flex: auto;\n      margin-left: 15px; }\n  .tracks-list::-webkit-scrollbar {\n    display: none; }\n\n@media (max-width: 992px) {\n  .tracks-list {\n    box-shadow: none;\n    border-radius: 0; } }\n"

/***/ },
/* 115 */
/***/ function(module, exports) {

	module.exports = "<div class=\"tracks-list\">\n  <div *ngFor=\"let track of tracks.models\" class=\"track\"\n       draggable=\"true\"\n       [dragData]=\"track.toJSON()\"\n       [dragImageUrl]=\"track.get('artwork_url').getSmallSize()\"\n       dragEffect=\"copy\">\n    <div class=\"cover\" (click)=\"gotoDetail(track)\">\n      <img [src]=\"track.get('artwork_url').getSmallSize()\"\n           [alt]=\"track.get('title')\"\n           [srcset]=\"track.get('artwork_url').getSmallSize()+' 200w, ' + track.get('artwork_url').getDefaultSize()+' 400w'\">\n    </div>\n    <div class=\"details\">\n      <!--<toggle-liked-track [track]=\"track\"></toggle-liked-track>-->\n      <b>{{track.get('title')}}</b>\n      <p>{{track.get('user').get('username')}}</p>\n      <play-button [track]=\"track\" [tracks]=\"tracks\"></play-button>\n      <queue-button [track]=\"track\" [tracks]=\"tracks\"></queue-button>\n      <button class=\"btn btn-danger btn-round\" title=\"Like track\">\n        <toggle-liked-track [track]=\"track\"></toggle-liked-track>\n      </button>\n      <button *ngIf=\"canBeDeleted\"\n              class=\"btn btn-default btn-round\"\n              title=\"Delete track\"\n              (click)=\"track.destroy()\">\n        <i class=\"fa fa-trash\"></i>\n      </button>\n    </div>\n  </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	const core_1 = __webpack_require__(3);
	const track_model_1 = __webpack_require__(100);
	const session_model_1 = __webpack_require__(117);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const core_1 = __webpack_require__(3);
	const authenticated_user_model_1 = __webpack_require__(118);
	const session_manager_fn_1 = __webpack_require__(104);
	const soundcloud_model_1 = __webpack_require__(102);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const user_model_1 = __webpack_require__(101);
	const underscore_1 = __webpack_require__(65);
	const authenticated_user_liked_tracks_collection_1 = __webpack_require__(119);
	const authenticated_user_playlists_collection_1 = __webpack_require__(121);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const core_1 = __webpack_require__(3);
	const authenticated_user_liked_track_model_1 = __webpack_require__(120);
	const soundcloud_collection_1 = __webpack_require__(113);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const core_1 = __webpack_require__(3);
	const playlists_collection_1 = __webpack_require__(122);
	const authenticated_user_playlist_model_1 = __webpack_require__(124);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const playlist_model_1 = __webpack_require__(123);
	const core_1 = __webpack_require__(3);
	const soundcloud_collection_1 = __webpack_require__(113);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const playlist_model_1 = __webpack_require__(123);
	const underscore_1 = __webpack_require__(65);
	const authenticated_user_playlist_tracks_collection_1 = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const core_1 = __webpack_require__(3);
	const tracks_collection_1 = __webpack_require__(112);
	const authenticated_user_playlist_track_model_1 = __webpack_require__(126);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const track_model_1 = __webpack_require__(100);
	const tracks_collection_1 = __webpack_require__(112);
	const play_queue_collection_1 = __webpack_require__(130);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const play_queue_item_model_1 = __webpack_require__(131);
	const underscore_1 = __webpack_require__(65);
	const soundcloud_collection_1 = __webpack_require__(113);
...
/***/ function(module, exports) {
	...
	module.exports = "<button class=\"btn btn-round btn-brand\" *ngIf=\"!isPlaying()\" (click)=\"play()\">\n  <i class=\"fa fa-play play\"></i>\n</button>\n<button class=\"btn btn-round btn-brand\" *ngIf=\"isPlaying()\" (click)=\"pause()\">\n  <i class=\"fa fa-pause\"></i>\n</button>\n";
	...
	let CloudPlayerLogoComponent = class CloudPlayerLogoComponent {
	    ...
	    ngOnInit() {
	        this.svgObject.nativeElement.addEventListener('load', () => {
	            ...
	            this.svgEl = content.getElementById('cloudPlayerCassette');
	            this.pause();
	        }, false);
	    }
	    play() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "<div class=\"cloud-player-logo\">\n  <object type=\"image/svg+xml\" data=\"" + __webpack_require__(158) + "\" #svgObject>\n    <img src=\"" + __webpack_require__(158) + "\" alt=\"Cloud Player\">\n  </object>\n</div>\n";

/***/ },
/* 158 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "493d6f20cd41a316c0068561897ebf4a.svg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	const core_1 = __webpack_require__(3);
	const index_component_1 = __webpack_require__(173);
	const tracks_module_1 = __webpack_require__(81);
	const dashboard_routes_1 = __webpack_require__(177);
	const platform_browser_1 = __webpack_require__(21);
	const forms_1 = __webpack_require__(60);
	const session_module_1 = __webpack_require__(178);
	const backbone_module_1 = __webpack_require__(64);
	const shared_module_1 = __webpack_require__(109);
	const search_filter_component_1 = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const tracks_collection_1 = __webpack_require__(112);
	const collection_text_input_search_component_1 = __webpack_require__(165);
	const localforage = __webpack_require__(174);
	...
	DashboardIndexComponent = __decorate([
	    ...
	    __metadata('design:paramtypes', [(typeof (_b = typeof tracks_collection_1.Tracks !== 'undefined' && tracks_collection_1.Tracks) === 'function' && _b) || Object])
...
/***/ function(module, exports, __webpack_require__) {
	...
	const platform_browser_1 = __webpack_require__(21);
	const forms_1 = __webpack_require__(60);
	const connect_btn_component_1 = __webpack_require__(179);
	const session_routes_1 = __webpack_require__(182);
	const soundcloud_callback_component_1 = __webpack_require__(183);
	const show_when_authenticated_1 = __webpack_require__(198);
	const authenticated_user_playlists_1 = __webpack_require__(193);
	const liked_tracks_view_component_1 = __webpack_require__(186);
	const shared_module_1 = __webpack_require__(109);
	const user_playlist_view_component_1 = __webpack_require__(189);
	const authenticated_user_playlists_view_component_1 = __webpack_require__(192);
	const playlist_module_1 = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const core_1 = __webpack_require__(3);
	const tracks_module_1 = __webpack_require__(81);
	const playlist_routes_1 = __webpack_require__(201);
	const platform_browser_1 = __webpack_require__(21);
	const playlist_view_component_1 = __webpack_require__(202);
	const shared_module_1 = __webpack_require__(109);
	const playlist_icon_component_1 = __webpack_require__(205);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const forms_1 = __webpack_require__(60);
	const platform_browser_1 = __webpack_require__(21);
	const playqueue_component_1 = __webpack_require__(216);
	const shared_module_1 = __webpack_require__(109);
	const audio_player_component_1 = __webpack_require__(219);
	const audio_player_controls_component_1 = __webpack_require__(223);
	const underscore_1 = __webpack_require__(65);
	const localforage = __webpack_require__(174);
	const play_queue_collection_1 = __webpack_require__(130);
	const tracks_collection_1 = __webpack_require__(112);
...
/***/ function(module, exports) {
	...
	module.exports = "@import url(\"https://fonts.googleapis.com/css?family=Raleway:300,400,500,600\");\n.play-queue {\n  overflow-x: hidden;\n  overflow-y: auto;\n  padding: 10px 0;\n  margin-top: -5px;\n  height: calc(100vh - 490px);\n  background: #fcfcfc; }\n  .play-queue div.queued-tracks-list div.track, .play-queue div.scheduled-tracks-list div.track {\n    padding: 0;\n    margin: 5px 0; }\n    .play-queue div.queued-tracks-list div.track div.details b, .play-queue div.scheduled-tracks-list div.track div.details b {\n      font-weight: bold; }\n  .play-queue::-webkit-scrollbar {\n    display: none; }\n\n@media (max-width: 767px) {\n  :host {\n    display: none; } }\n"

/***/ },
/* 218 */
/***/ function(module, exports) {

	module.exports = "<div class=\"play-queue\">\n\n  <div class=\"queued-tracks-list\" *ngIf=\"playQueue.getScheduledItems().length > 0\">\n    <div *ngFor=\"let playQueueItem of playQueue.getQueuedItems()\" class=\"track col-md-12\">\n      <div class=\"cover col-md-4\">\n        <img [src]=\"playQueueItem.get('track').get('artwork_url').getDefaultSize()\" [alt]=\"playQueueItem.get('track').get('title')\">\n      </div>\n      <div class=\"details col-md-8\">\n        <b>{{playQueueItem.get('track').get('title')}}</b>\n        <p>{{playQueueItem.get('track').get('user').get('username')}}</p>\n      </div>\n    </div>\n  </div>\n\n  <div class=\"scheduled-tracks-list\" *ngIf=\"playQueue.getScheduledItems().length > 0\">\n    <div *ngFor=\"let playQueueItem of playQueue.getScheduledItems()\" class=\"track col-md-12\">\n      <div class=\"cover col-md-4\">\n        <img [src]=\"playQueueItem.get('track').get('artwork_url').getDefaultSize()\" [alt]=\"playQueueItem.get('track').get('title')\">\n      </div>\n      <div class=\"details col-md-8\">\n        <b>{{playQueueItem.get('track').get('title')}}</b>\n        <p>{{playQueueItem.get('track').get('user').get('username')}}</p>\n      </div>\n    </div>\n  </div>\n\n</div>\n\n<!--\n<div class=\"play-queue\">\n\n  <hr\n    *ngIf=\"playQueue.getCurrentItem() && (playQueue.getScheduledItems().length>0 || playQueue.getQueuedItems().length>0)\">\n\n  <div *ngIf=\"playQueue.getQueuedItems().length>0\"\n       class=\"queued-items\">\n    Queued Items\n    <ul>\n      <li *ngFor=\"let playQueueItem of playQueue.getQueuedItems()\">\n        {{playQueueItem.get('track').get('title')}}\n      </li>\n    </ul>\n  </div>\n\n  <hr *ngIf=\"playQueue.getScheduledItems().length>0 && playQueue.getQueuedItems().length>0\">\n\n  <div *ngIf=\"playQueue.getScheduledItems().length>0\"\n       class=\"scheduled-items\">\n    Coming up next\n    <ul>\n      <li *ngFor=\"let playQueueItem of playQueue.getScheduledItems()\">\n        {{playQueueItem.get('track').get('title')}}\n      </li>\n    </ul>\n  </div>\n\n</div>\n\n<hr>\n\n<ul>\n  <li *ngFor=\"let playQueueItem of playQueue.models; let i = index\"\n      (dblclick)=\"playQueueItem.play()\"\n      [style.font-weight]=\"playQueue.getCurrentItem() && playQueue.getCurrentItem().id === playQueueItem.id ? 900 : 400\"\n      [class.text-muted]=\"playQueueItem.isQueued()\">\n    <span *ngIf=\"i===playQueue.playIndex\"> > </span>\n    {{playQueueItem.get('status')}}\n    <span>{{playQueueItem.get('track').get('title')}}</span>\n  </li>\n</ul>\n-->\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	const platform_browser_1 = __webpack_require__(21);
	const forms_1 = __webpack_require__(60);
	const users_routes_1 = __webpack_require__(227);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const session_model_1 = __webpack_require__(117);
	const auth_service_1 = __webpack_require__(229);
	const client_detector_service_1 = __webpack_require__(230);
	let NavComponent = class NavComponent {
	    ...
	    showDesktopAppEntry() {
	        ...
	        return ((os.name === client_detector_service_1.OsNames.MacOs && os.version > 0) || (os.name === client_detector_service_1.OsNames.Windows && os.version >= 7));
	    }
	};
